  ...
  return (
    <>
      ...
      <section className="content extendedContent">
        <h2>Resume</h2>
        <p className="summary">
          I am a Front-End Developer at the OptOut Media Foundation. In
          addition, I am a talented problem solver, critical thinker, and
          communicator, aided by my previous experience as a college-level
          Spanish instructor.
        </p>
        ...
        <section className="resumeSection project">
          ...
          <section className="projectInfo">
            ...
            <div className="projectDesc">
              <ul>
                <li className="description">
                  Utilized my skills with React Native, Firebase, and Git to
                  build front-end and back-end features on an AirB&B-type app
                  for political campaign staff and volunteers.
                </li>
                <li className="description">
        ...
        <section className="resumeSection project">
          ...
          <section className="projectInfo">
            ...
            <div className="projectDesc">
              <ul>
                <li className="description">
                  Created an online neighborhood map application using React,
                  the Google Maps JavaScript API, and the FourSquare Places API.
                </li>
                <li className="gitHub">
                  <a
                    className="url"
        ...
        <section className="resumeSection project">
          <div className="dates">Nov 2018</div>
          <section className="projectInfo">
            <div className="projectTitle">
              <a
                className="projectLink"
                href="projects/myReads/"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <div className="projectDesc">
              <ul>
                <li className="description">
                  Built an online bookshelf application using React and
                  Udacity's React Nanodegree's Books API.
                </li>
                <li className="description">
                  Leveraged React Router to properly route the application.
                </li>
                <li className="gitHub">
                  <a
                    className="url"
                    href="https://github.com/devrmateo/my-reads-a-book-tracking-app"
                    target="_blank"
                    rel="noreferrer"
                  >
                    https://github.com/devrmateo/my-reads-a-book-tracking-app
                  </a>
                </li>
              </ul>
            </div>
        ...
        <section className="resumeSection project">
          <div className="dates">Oct 2018</div>
          <section className="projectInfo">
            <div className="projectTitle">
              <a
                className="projectLink"
                href="projects/restaurantReviews/"
                target="_blank"
              >
                Restaurant Reviews
              </a>
            ...
            <div className="projectDesc">
              <ul>
                <li className="description">
                  Built restaurant reviews application with a focus on
                  responsive design, accessibility, and offline access.
                </li>
                <li className="description">
                  Utilized media queries, responsive image techniques and a
                  service worker to cache content for offline use.
                </li>
                <li className="gitHub">
                  <a
                    className="url"
                    href="https://github.com/devrmateo/restaurant-reviews-app"
                    target="_blank"
                    rel="noreferrer"
                  >
                    https://github.com/devrmateo/restaurant-reviews-app
                  </a>
                </li>
              </ul>
            </div>
        ...
        <section className="resumeSection">
          ...
          <section className="details">
            ...
            <ul className="duties">
              <li className="description">
                Build front-end features as a volunteer developer for a
                non-profit news aggregator app.
              </li>
              <li className="description">
        ...
        <section className="resumeSection">
          ...
          <section className="details">
            ...
            <ul className="duties">
              <li className="description">
                Built front-end and back-end features as a volunteer developer
                in service to a political campaign.
              </li>
              <li className="description">
        ...
        <section className="resumeSection">
          ...
          <section className="details">
            ...
            <ul className="duties">
              <li className="description">
                Communicated with potential voters through community canvasses
                and on the phone in both English and Spanish.
              </li>
              <li className="description">
                Lead community canvasses by organizing a staging area and
                training volunteers.
              </li>
            </ul>
          </section>
        ...
        <section className="resumeSection">
          ...
          <section className="details">
            ...
            <ul className="duties">
              <li className="description">
                Provided individualized technical support through code reviews
                and one-on-one virtual calls with students.
              </li>
              <li className="description">
        ...
        <section className="resumeSection">
          ...
          <section className="details">
            ...
            <ul className="duties">
              <li className="description">
                Taught introductory and heritage Spanish classes and
                collaborated actively with colleagues in organizing college
                activities.
              </li>
              <li className="description">
        ...
        <section className="resumeSection">
          ...
          <section className="details">
            ...
            <ul className="duties">
              <li className="description">
                Taught introductory Spanish classes and worked with colleagues
                to promote departmental activities and initiatives.
              </li>
              <li className="description">
                Employed best teaching practices in more than ten class
                sections, including several evening and weekend courses.
              </li>
            </ul>
          </section>
        </section>
          ...
          <section className="details">
            ...
            <ul className="duties">
              <li className="description">
                ...
                conferred with graduate-student colleagues regarding best
                teaching practices.
              </li>
              <li className="description">
          ...
          <section className="details">
            ...
            <ul className="duties">
              ...
              <li className="description">
                ...
                university's study abroad program to more than fifty
                undergraduate students.
              </li>
            </ul>
          </section>
          ...
          <section className="details">
            ...
            <ul className="duties">
              <li className="description">
                ...
                participated actively in departmental and school-wide
                activities.
              </li>
              <li className="description">
